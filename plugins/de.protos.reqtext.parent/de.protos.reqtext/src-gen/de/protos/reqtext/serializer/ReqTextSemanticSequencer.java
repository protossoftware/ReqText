...
public class ReqTextSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Image(ISerializationContext context, Image semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ReqTextPackage.Literals.IMAGE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReqTextPackage.Literals.IMAGE__NAME));
			if (transientValues.isValueTransient(semanticObject, ReqTextPackage.Literals.IMAGE__URL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ReqTextPackage.Literals.IMAGE__URL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getImageAccess().getNameCC_STRINGTerminalRuleCall_0_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getImageAccess().getUrlCC_STRINGTerminalRuleCall_1_0(), semanticObject.getUrl());
		feeder.finish();
	}
