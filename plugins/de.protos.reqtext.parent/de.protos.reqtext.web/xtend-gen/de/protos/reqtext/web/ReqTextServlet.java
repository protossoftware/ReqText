...
import de.protos.reqtext.web.ReqTextWebSetup;
...
public class ReqTextServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      ReqTextWebSetup _reqTextWebSetup = new ReqTextWebSetup(executorServiceProvider);
      _reqTextWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
